...
<Card title="In this lesson you will learn to:" icon="open-book">
  - use simple greetings - introduce yourself - use personal pronouns - use verb
  forms that are appropriate to the different pronouns - ask questions - make
  requests - express politeness
</Card>
